...
DATA_CACHE_DIR = "data"
DATA_SET_NAME = "blogdataset"
DATA_SET_URL = "https://huggingface.co/datasets/Gauravpadamtoo/blogdata/resolve/main/filtered.json"
DATA_SET_FILE_NAME = "filtered.json"

instruction_key = os.getenv('JSON_INSTRUCTION_KEY')
input_key = os.getenv('JSON_INPUT_KEY')
...
def pretokenize():
    ...
    def process_shard(shard):
        ...
        all_tokens = []
        for example in tqdm(data):
            text = example[instruction_key]
            if input_key in example and example[input_key].strip():  # checks if "input" contains non-whitespace text
